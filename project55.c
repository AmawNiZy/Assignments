...
void printQuadrant(int quadrant)
{
    switch (quadrant)
    {
    case 1:  //if angle is greater than 90 and less than 180 it displays this
        printf("The angle is in Quadrant 1 and on the positive X-axis");
        break;
    case 2:  //if angle is greater than 180 and less than 270 it displays this
        printf("The angle is in Quadrant 2 and on the positive Y-axis");
        break;
    case 3: //if angle is greater than 270 and less than 360 it displays this
